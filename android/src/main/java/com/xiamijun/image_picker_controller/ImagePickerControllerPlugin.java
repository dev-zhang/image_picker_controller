...
public class ImagePickerControllerPlugin
  ...
  public static void registerWith(PluginRegistry.Registrar registrar) {
    ...
    ImagePickerControllerPlugin plugin = new ImagePickerControllerPlugin();
  ...
  public ImagePickerControllerPlugin() {}

  @VisibleForTesting
  ImagePickerControllerPlugin(final ImagePickerDelegate delegate, final Activity activity) {
